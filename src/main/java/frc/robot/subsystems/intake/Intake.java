...
public class Intake {
  ...
  public Intake(IntakeIO io, TimesConsumer consumer, BooleanSupplier bumpSupplier) {
    ...
    Logger.recordOutput("Intake/State", m_currentState);
  }
  ...
  public void periodic() {
    ...
    Logger.recordOutput("Intake/State", m_currentState);
    Logger.recordOutput("Intake/WasUp", m_wasUp);
    Logger.recordOutput("Intake/WasJammed", m_wasJammed);
    Logger.recordOutput("Intake/WasStuck", m_wasStuck);
  }
  ...
  public boolean isJammed() {
    boolean jammed =
        m_io.getRollerCurrent().in(Amps) >= JamDetectionConstants.IntakeRollers.kJamCurrent.in(Amps)
            && m_io.getRollerVelocity().in(RotationsPerSecond)
                <= JamDetectionConstants.IntakeRollers.kJamSpeedThreshold.in(RotationsPerSecond);
    Logger.recordOutput("Intake/Jammed", jammed);
    return jammed;
  }
  ...
  public boolean isStuck() {
    boolean stuck =
        m_io.getDeploymentCurrent().in(Amps)
