...
public class Intake {
  ...
  public enum IntakeStates {
    ...
    UpAndIntake(Milliseconds.of(60), Rotations.of(0.29), 1.0, 1.75, 1.5),
    Half(Milliseconds.of(60), Rotations.of(0.15), 1.0, 1.75, 1.5),
    Down(Milliseconds.of(60), Degrees.of(0), 0, 1.75, 1.5),
    Jostle(Milliseconds.of(20), Rotations.of(0.05), Rotations.of(0.125), 1.0, 1.75, 1.5),
    Jammed(Milliseconds.of(20), Degrees.of(0), -0.3, 1.75, 1.5),
    Intaking(Milliseconds.of(20), Degrees.of(0), 1.0, 1.75, 1.5);
