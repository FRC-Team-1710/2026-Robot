...
public class DrivetrainAutomationConstants {
  ...
  public static class BumpDetection {
    ...
    public static final LinearVelocity kBumpFast = TunerConstants.kSpeedAt12Volts.times(0.4);

    public static final LinearVelocity kMinimumSpeedRequest =
        TunerConstants.kSpeedAt12Volts.times(0.25);

    public static final Angle kMinimumAngleThreshold = Degrees.of(7.5);

    public static final Rotation2d kShouldRaiseIntake1 = Rotation2d.fromDegrees(140);
    public static final Rotation2d kShouldRaiseIntake2 = Rotation2d.fromDegrees(-140);
    public static final Rotation2d kOtherRotation1 = Rotation2d.fromDegrees(20);
    public static final Rotation2d kOtherRotation2 = Rotation2d.fromDegrees(-20);
  }
}
